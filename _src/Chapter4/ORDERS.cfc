<cfcomponent persistent="true" table="ORDERS"  schema="APP" output="false">
	...
	<cfproperty name="ORDERSTATUSID" column="ORDERSTATUSID" type="numeric" ormtype="int" 
	...
	<cfproperty name="item" fieldtype="many-to-many"
		cfc="ART" fkcolumn="ORDERID"
		linkTable="ORDERITEMS" inverseJoinColumn="ARTID">
	<cfproperty name="orderstatus"  fieldtype="many-to-one"
		cfc="ORDERSTATUS"  fkcolumn="ORDERSTATUSID" >
